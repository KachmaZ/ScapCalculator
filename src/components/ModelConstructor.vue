        ...
        ><VCard min-height="300px" height="100%" variant="outlined" color="primary">
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.ModelTitle"
                single-line
                hide-details
                density="compact"
              ></VTextField>
        ...
        <VCard min-height="300px" height="100%" variant="outlined" color="primary">
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.option.MinWeight"
                single-line
                hide-details
                density="compact"
              ></VTextField>
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.option.MaxWeight"
                single-line
                hide-details
                density="compact"
              ></VTextField>
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.option.MaxAltitudeCruise"
                single-line
                hide-details
                density="compact"
              ></VTextField>
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.option.TaxiFuelPerMin"
                single-line
                hide-details
                density="compact"
              ></VTextField>
          ...
          <VRow class="px-4">
            ...
            <VCol cols="6" class="d-flex align-center">
              <VTextField
                name="type"
                v-model="draftModel.info.option.APUBurnPerHour"
                single-line
                hide-details
                density="compact"
              ></VTextField>
